...
import com.javadocmd.actionTest.action.GateAction;
...
public class RaceActionGenerator {
	...
	public void setActions(final Group group, final RunnerActor jane,
		...
		// I can only use one instance of this GateAction because once it's added, it's always listening.
		GateAction waitForWinner = new GateAction(RaceWinEvent.class, 1);
